...
class CbrfController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        if(!is_null($valute)) {
            ...
            $valuteFromDataBase = $cbr->checkInDataBase_2($date, $valute);
...
//            exit();
            ...
            // var_dump($valuteFromDataBase[14][0]['charcode']);
...
//        exit();
        ...
        // массив уникальных id, состоящий из хэш-функции md5 (date+CharCode)
        $uids_array = [];
        ...
        return $cbr->checkInDataBase($uids_array);

        // var_dump($cbr->checkInDataBase($uids_array));
        // exit();
